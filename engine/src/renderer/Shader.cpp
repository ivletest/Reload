...
//    lib->capacity = SHADERLIB_INIT_CAPACITY;
//    lib->total = 0;
//    lib->items = (ShaderProgram **)calloc(1, sizeof(ShaderProgram *) * SHADERLIB_INIT_CAPACITY);
//
//    if (!lib->items)
//    {
...
//    // {
//    //     if (shader->name == lib->items[i]->name)
//    //     {
//    //         SDL_LogError(
...
//    // }
//
//    // if (lib->capacity == lib->total)
//    // {
//    //     lib->capacity *= 2;
//    //     ShaderLib *items = realloc(lib->items, sizeof(ShaderLib *) * lib->capacity);
//    //     if (items)
//    //     {
//    //         lib->items = items;
//    //     }
